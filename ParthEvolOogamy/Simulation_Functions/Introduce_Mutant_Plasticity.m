function [mgenotypes,alphagenotypes,mgenotypes2,alphagenotypes2,f,f2]=Introduce_Mutant_Plasticity(mgenotypes,mgenotypes2,alphagenotypes,alphagenotypes2,f,f2,f0,A,M,T,Cz,Cp,beta,beta2,G,delta,plasticity,alphamax,Env1,Env2)
...
while Nev<=1
       ...
       if randn<0                                                           % if randn<0 mutate in mass, else mutate in \alpha.
           ...
           if plasticity==1
              if Env2==1                                                   % if rand<0.5, mutate in environment 2, else mutate in environment 1.
     ...
     if plasticity==1
         if Env2==1
         f2=Invasion_dynamics(mgenotypes2,alphagenotypes2,S2,beta2,Cz,Cp,G,T,A,M,f2);
         else
         f=Invasion_dynamics(mgenotypes,alphagenotypes,S,beta,Cz,Cp,G,T,A,M,f);    
         end
     else
     f=Invasion_dynamics(mgenotypes,alphagenotypes,S,beta,Cz,Cp,G,T,A,M,f);    
     end
