...
switching_environments=0; return_traits=1; number_of_realisations=1; alphamax=0.1;
...
save('Data_files\FigD12\genotypeDATA_m.mat','genotypeDATA_m');
save('Data_files\FigD12\genotypeDATA_alpha.mat','genotypeDATA_alpha');