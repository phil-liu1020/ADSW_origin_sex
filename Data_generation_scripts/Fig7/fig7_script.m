...
[~,~,m,alpha,~,~]=Evolutionary_trajectories(number_of_realisations,m0,alpha0(i),A,M,T,Cz,Cp,beta1,beta2,lambda12,lambda21,mu,NEVOL,f0,delta,alphamax, switching_environments, plasticity, return_genotypes );
