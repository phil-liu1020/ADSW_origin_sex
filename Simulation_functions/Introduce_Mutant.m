...
%-------
       ...
       if randn<0                                                           % if randn<0 mutate in mass, else mutate in \alpha.
                ...
                mgenotypes(length(mgenotypes)+1)=round(mgenotypes(q+1)+delta*sign(randn),2);
                ...
                alphagenotypes(length(alphagenotypes)+1)=round(alphagenotypes(q+1)+delta*sign(randn),2);
